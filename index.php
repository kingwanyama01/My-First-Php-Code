...
<!-- TOP HEADER Start
	...
	<section id="top">
		<div class="container">
			<div class="row">
				<div class="col-md-7">
					<p class="contact-action"><i class="fa fa-phone-square"></i>IN CASE OF ANY QUESTIONS, CALL THIS NUMBER: <strong>+2547000000</strong></p>
				</div>
	...
	<header>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<a href="#">
						<img style="width: 20%;height: 20vh;" src="images/new_logo.png" alt="logo">
					</a>
				</div>
				<div class="col-md-12">
					<a href="#">
						<h1 class="text-danger">Johari Dishes</h1>
					</a>
